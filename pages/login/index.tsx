        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md shadow-2xl">
          <div className="bg-white py-8 px-6 shadow rounded-b-lg sm:px-10">
            ...
            <div className="relative">
              ...
              <label
                htmlFor="email"
                className=" left-0 -top-3.5 text-gray-500 text-md transition-all duration-200 ease-in-out peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm"
              >
                Email address
              </label>
            </div>
            ...
            {/* <div className="flex items-center">
              ...
              >
                I agree to the
                <a href="#" className="text-lime-400 hover:text-lime-300 mx-1">
                  Terms
                </a>
                and
                <a href="#" className="text-lime-400 hover:text-lime-300 mx-1">
