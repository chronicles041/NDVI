...
const ToWeather = ({ coordinates ,miniView}: Props) => {
  ...
  const MiniView = () => {
    return (
      <div className="flex flex-row= from-gray-900 to-gray-600    bg-gradient-to-r  font-medium text-white p-2  overflow-scroll rounded-xl h-auto w-full items-center justify-center">
          ...
          {nextWeather?.daily.map((d, i) => (
            ...
            >
              ...
              <div className="flex flex-col items-center gap-y-1  justify-end w-auto">
                ...
                <div className=" text-sm">{`${Math.round(d.pop * 100)} %`}</div>
              </div>
