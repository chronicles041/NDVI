...
export default function Weather() {
  return (
    <div className="flex flex-col items-center w-screen min-h-screen text-gray-700 p-10 bg-gradient-to-br from-green-600 via-green-300 to-green-100 ">
      <div className="w-full max-w-screen-sm bg-white p-10 rounded-xl ring-8 ring-white ring-opacity-40">
        <div className="flex justify-between">
          <div className="flex flex-col">
            <span className="text-6xl font-bold">24°C</span>
            <span className="font-semibold mt-3 text-gray-700">
        ...
        <div className="flex justify-between mt-12">
          ...
          <div className="flex flex-col items-center">
            <span className="font-semibold text-lg">25°C</span>
            <svg
              className="h-10 w-10 fill-current text-gray-400 mt-3"
              xmlns="http://www.w3.org/2000/svg"
              height="24"
      ...
      <div className="flex flex-col space-y-6 w-full max-w-screen-sm bg-white p-10 mt-10 rounded-xl ring-8 ring-white ring-opacity-40">
        <div className="flex justify-between items-center">
          <span className="font-semibold text-lg w-1/4">Sat, 30 April</span>
        ...
        <div className="flex justify-between items-center">
          <span className="font-semibold text-lg w-1/4">Sun, 31 April</span>
        ...
        <div className="flex justify-between items-center">
          <span className="font-semibold text-lg w-1/4">Mon, 1 May</span>
          <div className="flex items-center justify-end pr-10 w-1/4">
        ...
        <div className="flex justify-between items-center">
          <span className="font-semibold text-lg w-1/4">Tue, 2 April</span>
          <div className="flex items-center justify-end pr-10 w-1/4">
        ...
        <div className="flex justify-between items-center">
          <span className="font-semibold text-lg w-1/4">Wed, 3 April</span>
